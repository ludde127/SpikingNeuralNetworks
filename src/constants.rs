...
pub const MIN_SYNAPSE_WEIGHT: f32 = 0.0;
...
pub const MIN_NEURON_DECAY_RATE: f32 = 0.09; // Minimum neuron decay rate
...
pub const REWARD_AVERAGE_DURATION: f32 = 50.0; // 20 ms
pub const LEARNING_RATE: f32 = 1.0;//0.00001;